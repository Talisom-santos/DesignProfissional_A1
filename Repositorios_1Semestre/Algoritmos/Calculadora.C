...
double funcaoDivisao (double pn, double sn) {
				...
				adicionarAoHistorico("Divisão.", pn, sn, resultado); 
...
double funcaoExponenciacao (double pn, double sn) {
			...
			adicionarAoHistorico("Exponenciação.", pn, sn, resultado); 
...
double funcaoResto (double pn, double sn) {
			...
			adicionarAoHistorico("Modulo resto da divisão.", pn, sn, resultado); 
            return resultado;
...
double funcaoPorcentagem (double pn, double sn) {
			...
			adicionarAoHistorico("Porcentagem.", pn, sn, resultado); 
...
double funcaoHip (double pn, double sn) {
			...
			adicionarAoHistorico("Hipotenusa.", pn, sn, resultado);  
...
double funcaoSQRT (double pn) {
			...
			adicionarAoHistorico("Raiz quadrada.", pn, 0, resultado); 
...
double funcaoCBRT (double pn) {
			...
			adicionarAoHistorico("Raiz cubica.", pn, 0, resultado);  
...
double funcaoSin (double pn) {
			...
			adicionarAoHistorico("Seno.", pn, 0, resultado);       
...
double funcaoCos (double pn) {
			...
			adicionarAoHistorico("Cosseno.", pn, 0, resultado);    
...
double funcaoRad (double pn) {
			...
			adicionarAoHistorico("Tangente.", pn, 0, resultado);  
...
double funcaoASin (double pn) {
			...
			adicionarAoHistorico("Arcseno.", pn, 0, resultado);   
...
double funcaoACos (double pn) {
			...
			adicionarAoHistorico("Arccosseno.", pn, 0, resultado);  
...
double funcaoATan (double pn) {
			...
			adicionarAoHistorico("Arctangente.", pn, 0, resultado); 
...
double funcaoLog10 (double pn) {
			...
			adicionarAoHistorico("Logaritmo na base 10.", pn, 0, resultado); 
...
double funcaoLog (double pn) {
			...
			adicionarAoHistorico("Logaritmo natural.", pn, 0, resultado);  
...
double funcaoFat (double pn) {
            resultado = 1;
				...
				adicionarAoHistorico("funcaoFat.", pn, 0, resultado); 
...
double funcaoRTD (double pn) {
			...
			adicionarAoHistorico("Radianos para Graus.", pn, 0, resultado);  
...
double funcaoArrPB (double pn) {
			...
			adicionarAoHistorico("Arredondar para baixo.", pn, 0, resultado);  
...
double funcaoArrPC (double pn) {
			...
			adicionarAoHistorico("Arredondar.", pn, 0, resultado);  
...
double funcaoDTR (double pn) {
			...
			adicionarAoHistorico("Graus para radianos.", pn, 0, resultado);  
